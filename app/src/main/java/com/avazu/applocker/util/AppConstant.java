...
public abstract class AppConstant {
    ...
    public static final String APP_LOCK_PATTERN_ENABLE = "lock_type";
    public static final String APP_LOCK_PASSWORD = "app_password";
    public static final String APP_LOCK_PATTERN = "app_pattern";
