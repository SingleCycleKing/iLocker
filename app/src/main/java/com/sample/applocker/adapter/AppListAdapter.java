package com.sample.applocker.adapter;
...
public class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        try {
            Resources res = mContext.getPackageManager().getResourcesForApplication(mInfo.getPackageName());
            holder.icon.setImageDrawable(res.getDrawable(mInfo.getIconId()));
